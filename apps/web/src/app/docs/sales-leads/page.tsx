...
export const metadata: Metadata = {
  ...
  description:
    "Get prospects who opened your website or replied to your cold email outreach. Starting at $40 for 5 leads guaranteed.",
};
    ...
    <div>
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 grid sm:grid-cols-3 gap-4">
          <TierCard tier="Starter" quantity="5 leads guaranteed" price="$40" />
          <TierCard tier="Growth" quantity="50 leads guaranteed" price="$400" />
          <TierCard tier="Scale" quantity="500 leads guaranteed" price="$4,000" />
        </div>
      </section>
